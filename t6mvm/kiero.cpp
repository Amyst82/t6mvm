...
// AIRYZ --> PUT UR ACTIONS IN THIS ONE FOR DX9
/*typedef long(__stdcall* D3D9EndScene)(LPDIRECT3DDEVICE9);
D3D9EndScene o_D9EndScene = NULL;

long __stdcall hkEndScene9(LPDIRECT3DDEVICE9 pDevice)
{
	return o_D9EndScene(pDevice);
}*/