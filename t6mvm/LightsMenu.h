...
namespace LightsMenu
{
	...
	inline static void Reinit()
	{
		if (Lights::SelectedLight >= Lights::LightsList.size())
			Lights::SelectedLight = Lights::LightsList.size() - 1;
	...
	inline static void Draw()
	{
		...
		if (Lights::SelectedLight != -1 && Lights::LightsList.size() > 0 && inited)
		{
